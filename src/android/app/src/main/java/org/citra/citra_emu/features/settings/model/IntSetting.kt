...
enum class IntSetting(
    ...
    TILED_RENDERING(SettingKeys.tiled_rendering(), Settings.SECTION_UTILITY, 1),
    SGSR_SHARPNESS(SettingKeys.sgsr_sharpness(), Settings.SECTION_RENDERER, 100),
    BLENDED_SHADING_RATE(SettingKeys.blended_shading_rate(), Settings.SECTION_UTILITY, 1),
